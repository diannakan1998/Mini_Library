 ...
 */
class currentRentals extends ComponentDialog {
  ...
  /**
     ...
     * @param {WaterfallStepContext} step contextual information for the current step being executed
     */
    async showRentals(step) {
        const userProfile = await this.userProfileAccessor.get(step.context);
        await step.context.sendActivity(`Here are your current rentals:`);
...
exports.currentRentalsDialog = currentRentals;
