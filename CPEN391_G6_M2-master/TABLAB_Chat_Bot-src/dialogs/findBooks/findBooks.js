 ...
 */
class findBooks extends ComponentDialog {
    constructor(dialogId, userProfileAccessor) {
        ...
        this.addDialog(new WaterfallDialog(PROFILE_DIALOG, [
            ...
            this.showLocalLibrariesWBook.bind(this)
  ...
  /**
     ...
     * @param {WaterfallStepContext} step contextual information for the current step being executed
     */
    async showLocalLibrariesWBook(step) {
        const userProfile = await this.userProfileAccessor.get(step.context);
        await step.context.sendActivity(`Here are the libraries near you with ${ userProfile.bookTitle } in stock:`);
...
exports.findBooksDialog = findBooks;
