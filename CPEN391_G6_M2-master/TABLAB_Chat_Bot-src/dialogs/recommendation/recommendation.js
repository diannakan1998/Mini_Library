 ...
 */
class recommendation extends ComponentDialog {
  ...
  /**
     ...
     * @param {WaterfallStepContext} step contextual information for the current step being executed
     */
    async showRecommendations(step) {
        const userProfile = await this.userProfileAccessor.get(step.context);
        await step.context.sendActivity(`I would recommend these books:`);
...
exports.recommendationDialog = recommendation;
