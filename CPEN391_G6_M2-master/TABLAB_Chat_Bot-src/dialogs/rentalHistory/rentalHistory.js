 ...
 */
class rentalHistory extends ComponentDialog {
  ...
  /**
     ...
     * @param {WaterfallStepContext} step contextual information for the current step being executed
     */
    async showHistory(step) {
        const userProfile = await this.userProfileAccessor.get(step.context);
        await step.context.sendActivity(`Here is your recent rental history, to view the full history please visit your profile information:`);
...
exports.rentalHistoryDialog = rentalHistory;
