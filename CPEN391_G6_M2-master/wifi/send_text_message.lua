...
function check_wifi(phone, name, date)
  ip = wifi.sta.getip()
 ...
 if(ip==nil) then
  ...
  message = "Hello, this is a reminder to please return \"" .. name .. 
  "\" that you have borrowed by " .. date .. " (dd-mm-yy) to any of our libraries as listed at: http://13.59.131.180:3000/\nThank you for participating in Take a Book Leave a Book!"
  send_sms("(778) 200-3016",phone,message)
