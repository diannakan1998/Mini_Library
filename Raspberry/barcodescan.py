        ...
        try:
                ...
                while True:
                        ...
                        if data[0] == '1':
                                ...
                                #change <= to = 
                                query = 'SELECT Phone_Number, Title, Takeout_Date + INTERVAL 21 DAY FROM User NATURAL JOIN Book_Rental NATURAL JOIN Book WHERE Takeout_Date <= NOW() - INTERVAL 18 DAY AND Return_Date IS NULL;'
                                print(sendDBQuery(query, cur))
                                #print(cur.fetchall())
